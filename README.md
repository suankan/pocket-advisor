...
The MCP tool returns source packets. The client or agent generates prose and should cite the packet indexes. Pocket Advisor does not send corpus data to an answer model automatically.
