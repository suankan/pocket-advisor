...
|---|---|---|---|---|
| **R-03b** | Visual golden eval + measure `IMG_RRF_WEIGHT` / `ocr_proxy` vs skip | Visual | After live `ingest.py images` produces a usable index | [visual-retrieval.md](specs/visual-retrieval.md) |
