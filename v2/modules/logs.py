...
from v2.modules.config import PROJECT_ROOT, Config
...
def _write_terminal(message: str, stream: Any) -> None:
    ...
    from v2.modules.runtime_dashboard import active_dashboard
...
class Log:
    ...
    def worker_pool(self, label: str, workers: int, total: int,
                    **kwargs: Any) -> Any:
        from v2.modules.progress import WorkerPoolProgress
